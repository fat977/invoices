	...
	<div class="main-sidemenu">
		...
		@can('الفواتير')
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					<li><a class="slide-item" href="{{ url('/invoices?paid') }}">الفواتير المدفوعة</a></li>
					 @endcan 

					@can('الفواتير الغير مدفوعة') 
					<li><a class="slide-item" href="{{ url('/invoices?unpaid') }}">الفواتير الغير مدفوعة</a></li>
					 @endcan 

					@can('الفواتير المدفوعة جزئيا') 
					<li><a class="slide-item" href="{{ url('/invoices?partially') }}">الفواتير المدفوعة جزئياً</a></li>
					 @endcan 

					@can('ارشيف الفواتير') 
					<li><a class="slide-item" href="{{ url('/invoices?archive') }}">الفواتير المؤرشفة</a></li>
					 @endcan 
				</ul>
			</li>
			@endcan
		@can('التقارير')	
			...
			<li class="slide">
				...
				<ul class="slide-menu">
				@can('تقرير الفواتير')
					<li><a class="slide-item" href="{{ route('reports.invoice') }}">تقارير الفواتير</a></li>
					@endcan

				@can('تقرير العملاء')
					<li><a class="slide-item" href="{{ route('reports.customer') }}">تقارير العملاء</a></li>
					@endcan
				</ul>
			</li>
			@endcan
