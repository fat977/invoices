                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline-success btn-sm" 
                                        ...
                                        data-toggle="modal" data-target="#edit_Product">تعديل
                                    </button>
                                    <!-- edit -->
                                                ...
                                                <form action='{{ route('products.update',$product->id) }}' method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" class="form-control" name="id" id="pro_id" value="">
                                    ...
                                    <button class="btn btn-outline-danger btn-sm " data-pro_id="{{ $product->id }}" data-product_name="{{ $product->name }}" data-toggle="modal" data-target="#modaldemo9">حذف
                                    </button>
                                    <!-- delete -->
...
<script>
    $('#modaldemo9').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget)
        var id = button.data('id')
        var section_name = button.data('section_id')
        var modal = $(this)
        modal.find('.modal-body #id').val(id);
